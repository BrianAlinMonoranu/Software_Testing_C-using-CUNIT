...
int main()
{
    runAllTests();//call this function
}

void max_test_same()
{
    double max_1[]={-1.3, -1.45, -220, -100, -0.1, -0.1234, -200};
    CU_ASSERT_DOUBLE_EQUAL(max(max_1, 7), -0.1, 0.0001);//The first test
    double max_2[]={-1.3, 1.45, 220, 100, 0, 200, 0.1234};
    CU_ASSERT_DOUBLE_EQUAL(max(max_2, 7), 220, 0.0001);//The second test
}
